...
<div class="card">
  ...
  <div class="stages">
    ...
    <div class="stage live" data-st="synthwave" onclick="selectStation('synthwave')"><div class="ico">🔊</div><div class="nm">Boost</div><div class="desc">La scène du grand frisson, celle qu'on garde pour les moments où on a besoin qu'une musique nous relève. Ces drops mélodiques qui montent, montent, et te retournent au moment où tu t'y attends le moins — la hype qui serre la gorge, l'euphorie qui pique les yeux. Roule, cours, vole : elle est faite pour ça.</div><div class="st">Live</div><button class="cp" title="Copier le lien mp3" onclick="copyLink(event,'synthwave')">🔗</button></div>
